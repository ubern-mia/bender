...
changelog: change network from 4 layer to a deeper version.
"""
...
class CNN(nn.Module):
    """
    A deeper 6 layered CNN to run classification on dermamnist.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="dermamnist_v5_deeper_network")
    parser.add_argument(
        "mode",
        nargs="?",
        default="visualize",
